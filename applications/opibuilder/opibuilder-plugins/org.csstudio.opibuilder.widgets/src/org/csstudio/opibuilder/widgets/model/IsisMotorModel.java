...
/**
 * This class defines an ISIS motor widget model.
 * @author Tom Willemsen
 */
public class IsisMotorModel extends AbstractPVWidgetModel{
     ...
     */
    public static final String ID = "org.csstudio.opibuilder.widgets.isismotormodel"; //$NON-NLS-1$

    public IsisMotorModel() {
